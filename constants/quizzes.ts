    ...
    questions: [
        ...
        },
        {
            ...
            answers: [
                ...
                "HyperTerminal Machine Language",
            ],
            correctAnswer: 0,
        },
        {
...
export const MUSIC = {
    ...
    questions: [
        ...
        {
            question: "Who wrote the famous Symphony No. 5?",
        ...
        },
        {
            ...
            answers: ["Coachella", "Lollapalooza", "Glastonbury", "Woodstock"],
            correctAnswer: 3,
        },
        {
        ...
        },
        {
            ...
            answers: ["Violin", "Piano", "Bagpipes", "Harp"],
            correctAnswer: 2,
        },
        {
            question: "What is the main language of opera?",
            answers: ["German", "English", "French", "Italian"],
            correctAnswer: 3,
        },
        {
...
export const MOVIES = {
    ...
    questions: [
        ...
        },
        {
            ...
            answers: ["The Bodyguard", "Titanic", "Pretty Woman", "Ghost"],
            correctAnswer: 1,
        },
        {
...
export const SPORTS = {
    ...
    questions: [
        ...
        },
        {
            ...
            answers: ["USA", "Australia", "France", "England"],
            correctAnswer: 3,
        },
        {
            question: "In which sport do teams compete for the Stanley Cup?",
            answers: ["Basketball", "Baseball", "Ice Hockey", "Soccer"],
            correctAnswer: 2,
        },
        {
            question: "Which sport is associated with the term 'home run'?",
            answers: ["Basketball", "Baseball", "Cricket", "Soccer"],
            correctAnswer: 1,
        },
        {
...
export const ART = {
    ...
    questions: [
        ...
        },
        {
            ...
            answers: ["Impressionism", "Cubism", "Surrealism", "Pop Art"],
            correctAnswer: 2,
        },
        {
        ...
        {
            question:
                "Which art movement is characterized by the use of geometric shapes and a monochromatic color palette?",
            answers: ["Impressionism", "Cubism", "Surrealism", "Pop Art"],
            correctAnswer: 1,
        },
        {
...
export const LITERATURE = {
    ...
    questions: [
        ...
        {
            question: "Which Shakespeare play features the character Juliet?",
...
export const GEOGRAPHY = {
    ...
    questions: [
        ...
        },
        {
            ...
            answers: ["Danube", "Seine", "Thames", "Rhine"],
            correctAnswer: 1,
        },
        {
...
export const NATURE = {
    ...
    questions: [
        ...
        {
            question: "Which is the tallest tree species on Earth?",
            answers: ["Sequoia", "Redwood", "Eucalyptus", "Pine"],
            correctAnswer: 1,
        },
        {
            question: "What is the fastest land animal?",
            answers: ["Cheetah", "Lion", "Gazelle", "Horse"],
            correctAnswer: 0,
        },
        {
        ...
        },
        {
            ...
            answers: ["Polar Bear", "Grizzly Bear", "Panda Bear", "Black Bear"],
            correctAnswer: 0,
        },
        {
            question: "Which insect is known for its ability to produce silk?",
            answers: ["Bee", "Butterfly", "Ant", "Silkworm"],
            correctAnswer: 3,
        },
        {
        ...
        },
        {
            ...
            answers: ["Raccoon", "Possum", "Skunk", "Armadillo"],
            correctAnswer: 1,
        },
        {
...
export const MYTHOLOGY = {
    ...
    questions: [
        ...
        {
            question: "Which creature is half-man, half-horse?",
            answers: ["Minotaur", "Cyclops", "Centaur", "Satyr"],
            correctAnswer: 2,
        },
        {
            question: "Who is the Greek goddess of wisdom?",
            answers: ["Hera", "Aphrodite", "Artemis", "Athena"],
            correctAnswer: 3,
        },
        {
        ...
        {
            question: "Which Norse god is known as the Allfather?",
            answers: ["Thor", "Odin", "Loki", "Balder"],
            correctAnswer: 1,
        },
        {
            question: "What is the home of the Greek gods called?",
            answers: ["Asgard", "Mount Olympus", "Valhalla", "Elysium"],
            correctAnswer: 1,
        },
        {
            question: "Who is the Roman equivalent of the Greek god Zeus?",
            answers: ["Mars", "Jupiter", "Neptune", "Saturn"],
            correctAnswer: 1,
        },
        {
            question: "Which mythological creature has snakes for hair?",
            answers: ["Medusa", "Chimera", "Hydra", "Cerberus"],
            correctAnswer: 0,
        },
        {
            question: "Who is the god of war in Greek mythology?",
            answers: ["Apollo", "Ares", "Hephaestus", "Hermes"],
            correctAnswer: 1,
        },
        {
...
export const BUSINESS = {
    ...
    questions: [
        ...
        },
        {
            ...
            answers: ["Microsoft", "Intel", "IBM", "Google"],
            correctAnswer: 2,
        },
        {
        ...
        {
            question: "What is the main responsibility of a CFO?",
            answers: ["Marketing", "Finance", "Human Resources", "Operations"],
            correctAnswer: 1,
        },
        {
        ...
        },
        {
            ...
            answers: [
                ...
                "Systems, Workflows, Opportunities, Trends",
                "Strategy, Workers, Objectives, Targets",
            ],
            correctAnswer: 0,
        },
        {
...
export const COOKING = {
    ...
    questions: [
        ...
        },
        {
            ...
            answers: ["Cheddar", "Mozzarella", "Parmesan", "Gouda"],
            correctAnswer: 1,
        },
        {
        ...
        },
        {
            ...
            answers: ["Apple", "Orange", "Grapes", "Peach"],
            correctAnswer: 2,
        },
        {
...
export const HEALTH = {
    ...
    questions: [
        ...
        },
        {
            ...
            answers: ["Iron", "Calcium", "Magnesium", "Potassium"],
            correctAnswer: 1,
        },
        {
        ...
        },
        {
            ...
            answers: ["Quadriceps", "Hamstrings", "Gluteus Maximus", "Biceps"],
            correctAnswer: 2,
        },
        {
